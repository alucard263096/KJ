...
--
-- Table structure for table `welive_automsg`
--
...
--
-- Dumping data for table `welive_automsg`
--

LOCK TABLES `welive_automsg` WRITE;
/*!40000 ALTER TABLE `welive_automsg` DISABLE KEYS */;
INSERT INTO `welive_automsg` VALUES (1,1,1,'你好，请问有什么可以帮到你？');
/*!40000 ALTER TABLE `welive_automsg` ENABLE KEYS */;
UNLOCK TABLES;
